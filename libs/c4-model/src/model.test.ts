...
describe('Model', () => {
    ...
    describe('can define SoftwareSystems', () => {
        ...
        test('should not permit a SoftwareSystem to be defined multiple times', () => {
            ...
            expect(() => model.defineSoftwareSystem('softwareSystem')).toThrow(
                "A SoftwareSystem named 'softwareSystem' is defined elsewhere in this Model. A SoftwareSystem can be defined only once, but can be referenced multiple times."
            )
        })
    })
    ...
    describe('can validate the Model', () => {
        ...
        test.each([
            ...
            [
                defineTestModel4,
                "Elements named 'softwareSystem1.container1.component2', 'softwareSystem2.container2.component1' are referenced but not defined.",
            ],
        ])(
            'a Model that has not defined all Elements that are referenced should be considered invalid',
            (defineModel: (m: Model) => void, expectedError: string) => {
        ...
        function defineTestModel5(model: Model): void {
            ...
            const cont1 = sys1.defineContainer('container1', {
            ...
            const cont2 = sys1.defineContainer('container2', {
                description: 'description',
                technology: 'technology',
                tags: ['tag1', 'tag2'],
            })
        ...
        test.each([defineTestModel5])(
            'a Model that has defined all Elements that are referenced should be considered valid',
            (defineModel: (m: Model) => void) => {
                const model = new Model('model')
                defineModel(model)
